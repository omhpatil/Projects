...
private:
    ...
    struct person
    {
        ...
        string contact; // Change contact to a string
        int cash;
    } person[100];
...
void Bank::perData()
{
    ...
    getline(cin, person[total].contact); // Read the contact as a string
    cout << "Total Cash: ";
...
void Bank::update()
{
    cout << "Enter id of student whose data you want to update" << endl;
    cin >> id;
    for (int i = 0; i < total; i++)
    {
        if (id == person[i].ID)
...
void Bank::transactions()
{
    int cash;
    char ch;
    cout << "Enter id of student whose data you want to transaction" << endl;
    cin >> id;
    for (int i = 0; i < total; i++)
    {
        if (id == person[i].ID)
